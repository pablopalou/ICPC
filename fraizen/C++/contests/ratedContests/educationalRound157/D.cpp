...
vector<ll> construct_array(ll n, vi &a) {
    vi b(n);
    ll xor_sum = 0;
    ...
    if (set<ll>(b.begin(), b.end()).size() == n && *max_element(b.begin(), b.end()) < n) {
        return b;
    } else {
        b[n - 1] = 0;
        xor_sum = 0;
        ...
        // Return the array b with 0 at the end, as it's guaranteed to be valid
        return b;
    }
}
